...
def home():
    ...
    #     print ('home_param=', home_param)  
    #     home_list = DB.getHomeByQuery(queryObj=home_param)
        
    # if home_list == None:
    #     home_list=DB.get_n_home(lim=100)

    # return render_template("home.html", home_param=home_param, home_list=home_list)
